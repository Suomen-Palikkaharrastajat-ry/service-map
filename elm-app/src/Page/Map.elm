    ...
    case model.locations of
        ...
        Success locations ->
            ...
            div
                ...
                , style "transform" "translateX(-50%)"
                , style "z-index" "1000"
                , class "bg-white rounded shadow px-4 py-2 type-caption text-text-muted pointer-events-none"
                ]
                [ text (String.fromInt total ++ " " ++ t MapLocationsOnMap) ]
                    ...
                    , case loc.location of
                        Just address ->
                            ...
                            div [ class "flex items-start gap-2 type-caption text-text-muted" ]
                                ...
                                , a [ href osmUrl, target "_blank", class "hover:underline text-text-primary" ] [ text address ]
                                ]
